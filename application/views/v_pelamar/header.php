...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        <div class="container">
            <a class="navbar-brand" href="<?php echo base_url(); ?>c_pelamar/HomePelamar">Jobpply</a>
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo base_url(); ?>c_pelamar/c_contact">Contact</a>
                    </li>
                    <li class="nav-item cta cta-colored">
                        <a class="nav-link" href="<?php echo base_url(); ?>c_pelamar/job_post">Lowongan Pekerjaan</a>
                    </li>
                    <li class="nav-item">
