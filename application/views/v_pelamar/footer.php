      ...
      <div class="col-md">
        <div class="ftco-footer-widget mb-4">
          ...
          <ul class="list-unstyled">
            ...
            <li><a href="<?php echo base_url(); ?>Login" class="py-2 d-block">Tambah Loker</a></li>
          </ul>
        </div>
      </div>
      <div class="col-md">
        <div class="ftco-footer-widget mb-4 ml-md-4">
          ...
          <ul class="list-unstyled">
            <li><a href="<?php echo base_url(); ?>Login" class="py-2 d-block">Register</a></li>
            <li><a href="<?php echo base_url(); ?>c_pelamar/job_post" class="py-2 d-block">Lihat Lowongan Pekerjaan</a></li>
          </ul>
        </div>
      </div>
      <div class="col-md">
